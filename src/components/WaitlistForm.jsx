...
const WaitListForm = () => {
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem("points", randomPoints);
  }, []);
  ...
  const categoryTitles = {
    First: "What excites you about joining",
    Second: "How will you use our platform",
    Third: "How did you hear about us",
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {Object.keys(categoryTitles).map((category, idx) => (
                questions[category] && (
                  ...
                  >
                    <h3 className="font-bold mb-3">{categoryTitles[category]}</h3>
